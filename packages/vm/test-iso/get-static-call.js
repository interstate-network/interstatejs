...
const {StaticCallWitness} = require('../dist/witness/call')
...
let encoded = encodeAccess(new StaticCallWitness(
  new BN(0),
  new BN(0),
...
require('fs').writeFileSync('./static-call-witness.json', JSON.stringify(encoded, null, 2))
