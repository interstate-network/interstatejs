...
//     // this._tree = opts.trie || new Trie()
//     this._storageTries = {} // the storage trie cache
//     this._cache = new Cache(this._tree)
...
//   }
//   /**
//    * Gets the state root during a checkpoint by copying the cache,
//    * then checkpointing and writing to the state tree then reverting it.
//    */
//   async forceGetStateRoot(): Promise<Buffer> {
//     if (this._checkpointCount === 0) return this.getStateRoot();
//     this._tree.checkpoint()
//     // console.log('root before force -- ', this._tree.rootHash.toString('hex'))
//     const cache = new Cache(this._tree)
//     this._cache._cache.forEach((key: any, value: any) => {
//       cache._cache = cache._cache.insert(key, Object.assign({}, value));
//     });
//     await cache.flush();
//     const root = this._tree.rootHash;
...
//    */
//   // copy(): StateManager {
//   //   return new DefaultStateManager({ trie: this._tree.copy(false), common: this._common })
//   // }
...
//     }
//     await this._cache.flush()
//     const stateRoot = this._tree.rootHash
//     return stateRoot
//   }
...
//     if (stateRoot === this._tree.EMPTY_ROOT) {
//       await this._tree.setRoot(stateRoot)
//       this._cache.clear()
//       this._storageTries = {}
//       return
//     }

//     const hasRoot = await this._tree.checkRoot(stateRoot)
//     if (!hasRoot) {
...
//     return await this._tree.checkRoot(root)
//   }
...
//       await this._tree.update(addressBuffer, account.serialize())
//     }
//   }
