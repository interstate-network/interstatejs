...
library Structs {
	...
	internal pure returns (SloadWitness memory) {
		(uint256 opcode, uint256 slot, uint256 value) = abi.decode((data), (uint256, uint256, uint256));
	...
	internal pure returns (SstoreWitness memory) {
		(
			uint256 opcode, bytes32 stateRootLeave, uint256 slot, uint256 value, uint256 refund
		) = abi.decode((data), (uint256, bytes32, uint256, uint256, uint256));
		return SstoreWitness(opcode, stateRootLeave, slot, value, refund);
	}
	...
	internal pure returns (StaticCallWitness memory) {
		...
		) = abi.decode((data), (uint256, uint256, uint256, address, bytes32, bool, bytes));
	...
	internal pure returns (DelegateCallWitness memory) {
		(
			uint256 opcode, bytes32 stateRootLeave, uint256 gas, uint256 gasUsed,
			uint256 gasRefund, address to, bytes32 calldataHash, bool success, bytes memory returndata
		) = abi.decode((data), (uint256, bytes32, uint256, uint256, uint256, address, bytes32, bool, bytes));
		return DelegateCallWitness(opcode, stateRootLeave, gas, gasUsed, gasRefund, to, calldataHash, success, returndata);
	}
	...
	internal pure returns (CallWitness memory) {
		...
		return CallWitness(
			opcode, stateRootLeave, gas, gasUsed, gasRefund,
	...
	internal pure returns (BalanceWitness memory) {
		(uint256 opcode, address to, uint256 balance) = abi.decode((data), (uint256, address, uint256));
		return BalanceWitness(opcode, to, balance);
	}
	...
	internal pure returns (ExtCodeHashWitness memory) {
		(uint256 opcode, address target, bytes32 hash) = abi.decode((data), (uint256, address, bytes32));
		return ExtCodeHashWitness(opcode, target, hash);
	}
	...
	internal pure returns (ChainidWitness memory) {
		(uint256 opcode, uint256 chainId) = abi.decode((data), (uint256, uint256));
		return ChainidWitness(opcode, chainId);
	}
	...
	internal pure returns (BlockHashWitness memory) {
		(uint256 opcode, uint256 number, bytes32 hash) = abi.decode((data), (uint256, uint256, bytes32));
		return BlockHashWitness(opcode, number, hash);
	}
	...
	internal pure returns (Log1Witness memory) {
		(uint256 opcode, bytes32 topic, bytes32 dataHash) = abi.decode((data), (uint256, bytes32, bytes32));
	...
	internal pure returns (Log2Witness memory) {
		(uint256 opcode, bytes32 topic0, bytes32 topic1, bytes32 dataHash) = abi.decode((data), (uint256, bytes32, bytes32, bytes32));
	...
	internal pure returns (Log3Witness memory) {
		(
			uint256 opcode, bytes32 topic0, bytes32 topic1, bytes32 topic2, bytes32 dataHash
		) = abi.decode((data), (uint256, bytes32, bytes32, bytes32, bytes32));
	...
	internal pure returns (Log4Witness memory) {
		(
			uint256 opcode, bytes32 topic0, bytes32 topic1, bytes32 topic2, bytes32 topic3, bytes32 dataHash
